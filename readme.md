...
If you want to use the linked passage from BLINK, you can first download the linked passages from [all_constructed_blink_tables.json](https://github.com/zhongwanjun/CARP/releases/tag/blink-linked-table), then move the json file to `./data_wikitable`. After that, use the following command to preprocess.
