...
If you want to use the linked passage from BLINK, you can first download the linked passages from [](here), then move the json file to `./data_wikitable`. After that, use the following command to preprocess.
