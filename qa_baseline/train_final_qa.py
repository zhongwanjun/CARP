...
def test(args, model, tokenizer, prefix=""):
    ...
    test_dataset, test_examples, test_features, qid2idx = get_test_data(args)
    # Note that DistributedSampler samples randomly
...
def main():
    ...
    special_tokens_dict = {'additional_special_tokens': ["[HEADER]", "[PASSAGE]", "[TB]","[DATA]","[TITLE]","[SECTITLE]","[SEP]"]}
