...
export MODEL_DIR=longformer_large_ecmask_weighted_1e-5_squadv2
...
#export TOKENIZERS_PARALLELISM=false
#export TRAIN_DATA_PATH=${BASIC_DIR}/data/preprocessed_data/qa_evidence_chain/train_intable_p1_t360.pkl
#export DEV_DATA_PATH=${BASIC_DIR}/data/preprocessed_data/qa_evidence_chain/dev_intable_p1_t360.pkl
